...
// const inputList = Array.from(form.querySelectorAll('.feedback__form-input'))
// const buttonElement = form.querySelector('.feedback__form-button')
// const formErrorElement = form.querySelector('.feedback__form-empty-error')
...
// // Функция toggleButton() блокирует кнопку, когда находит невалидные поля,
// // и вновь активирует её, если все поля заполнены корректно.
...
// // Функция hasInvalidInput() проверяет поля ввода на наличие ошибок.
